...
// We defined this method as static because we need to call aggregate() on Model --> this needs to point to Model
reviewSchema.statics.calcAverageRatings = async function(tourId) {
    ...
    if(stats.length > 0) {
        ...
        await Tour.findByIdAndUpdate(tourId, { ratingsQuantity: 0, ratingsAverage: 5 })
    }
}
