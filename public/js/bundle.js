    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'status') location.assign('/');
            _context2.next = 10;
            break;
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IS2CMDqlnqZ5tYidWcJLISieoidt4TBfSopDmt8Srls7nAhi31tetAYXKwYECzBGLHHQFdkvxwZU4UIQwmXtcUZ00scIztlpK');
            _context.prev = 1;
            _context.next = 4;
